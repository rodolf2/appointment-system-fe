        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="flex items-center absolute top-6 left-6">
            ...
            <div className="flex items-baseline">
              <span className="text-background text-2xl md:text-3xl font-regular">
                LVCC
              </span>
              <span className="text-background text-2xl md:text-3xl font-LatoBold pl-2">
                AppointEase
              </span>
            </div>
          </div>
          ...
          <Link
            to="/home"
            className="mt-6 bg-[#161F55] hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded-md shadow-lg"
          >
            Get Started
          </Link>
        </div>
